 ...
 * existing firmware SpringBoard bundle. Run a fresh process to verify it.
 */
#include <dlfcn.h>
#include <stdio.h>
#include <string.h>
...
int main(int argc,char **argv) {
    ...
    if(registration) {
        ...
        Obj url=arg(class_named("NSURL"),"fileURLWithPath:",string("/System/Library/CoreServices/SpringBoard.app"));
