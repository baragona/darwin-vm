...
function setup(version) {
  ...
  const screen={focus(){},setPointerCapture(){},addEventListener(){},getBoundingClientRect(){return {left:0,top:0,width:100,height:100}}};
  ...
  return {screen,calls,timers,event,context};
}
...
(async()=>{
  ...
  assert.deepEqual(s.calls,['D 0.20000 0.30000','U 0.20000 0.30000']);
  console.log('PASS: quick taps, drags, holds, cancellation, and legacy guests');
